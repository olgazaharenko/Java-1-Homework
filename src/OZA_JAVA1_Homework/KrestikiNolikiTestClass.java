...
public class KrestikiNolikiTestClass {
	 ...
	 * 
	 * Игровая логика с использованием объектной модели
	 * -------------------------------------------------------------------------------------
	 * Выводим приглашение поиграть с компьютером, либо с человеком.
	 * Создаем объект Игра с передачей туда параметров, кто играет (человек-человек,
	 * человек-компьютер, компьютер-компьютер)
	 * Игра выводит правила игры, определяет кто чем ходит,
	 * и кто ходит первый, создает объекты Игроков, и объект Поле, решает кто выиграл.
	 * Игроки рассчитывают свои ходы - человек сам, у компьютера должен быть
	 * для этого метод.
	 * Поле принимает ходы и перерисовывается.
	 * 
	 * 
	 * Игровая логика. 
	 * -------------------------------------------------------------------------------------
