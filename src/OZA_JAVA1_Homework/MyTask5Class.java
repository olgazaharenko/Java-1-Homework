...
public class MyTask5Class {
	...
	public static void main(String[] args) {
			...
			int keyToWin;
			System.out.println ("I may guess the number in your head.");
	    	System.out.println ("Please think of a number from 1 to 100."); 
		...
		public static int askUserToCompareNumber (int lim) {
			...
			while (userAnswer != 0 && userAnswer != 1 && userAnswer != 2) { 
		    	System.out.println ("Either Your number is less (0), more (1) or equal (2) then " + lim + "? Enter 0, 1 or 2.");
